...
test("pull request workflow", async () => {
  ...
  const result = await act.setMatrix("node-version", ["24.x"]).runJob("unit", {
    mockSteps: {
      unit: [
        {
          name: "Test",
  ...
  {
    name: "Main actions/checkout@v6",
    status: 0,
    output: "",
  },
  {
    name: "Main actions/setup-node@v6",
  ...
  {
    name: "Post actions/setup-node@v6",
    output: "",
    status: 0,
  }
]);
